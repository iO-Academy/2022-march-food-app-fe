...
const ItemCard = ({foodName, price, calories, foodType, side, addItem, removeItem}) => {
    ...
    return(
        <>
            <div className = 'item_card'>
                ...
                <QuantityButtons foodName={foodName} price={price} addItem={addItem} removeItem={removeItem}/>
            </div>
